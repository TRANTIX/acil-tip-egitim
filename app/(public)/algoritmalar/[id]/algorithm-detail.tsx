...
export function AlgorithmPublicDetail({ algorithm }: Props) {
  return (
    <div className="space-y-8">
      ...
      <p className="text-center text-xs text-[var(--muted-foreground)]">
        Bu algoritma eğitim amaçlıdır. Klinik karar verme sürecinde klinik
        yargı ile birlikte değerlendirilmelidir.
      </p>
    </div>
  );
}
